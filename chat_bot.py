...
# DecisionTreeClassifier - outputs based on yes/no
...
cols= cols[:-1] # all cols except the last column
x = training[cols]
y = training['prognosis'] # last col
y1= y


reduced_data = training.groupby(training['prognosis']).max()
# last col for prdicting the final result
...
# after training testing fit it in the decision tree
clf = clf1.fit(x_train,y_train)
# print(clf.score(x_train,y_train))
# print ("cross result========")
# test model over 3 folds of dataset
scores = cross_val_score(clf, x_test, y_test, cv=3)
# print (scores)
print (scores.mean())

# testing data on the SVC model
model=SVC()
